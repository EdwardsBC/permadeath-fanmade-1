...
loot insert 100000 0 100000 loot eb001:1
data modify entity @s Attributes append from block 100000 0 100000 Items[2].tag.eb001
data modify entity @s Attributes append from block 100000 0 100000 Items[3].tag.eb001
